...
export default function Home() {
  ...
  return (
    <div className={`relative m-auto font-JetBrainsMono`}>
      <motion.div ref={ref} variants={boxVariant} initial="visible" animate={scroll} className={` md:hidden absolute md:right-[45%] right-[25%] top-[20%]`}>
        ...
        <HiArrowCircleDown className='ml-14 animate-bounce text-white' size={60} />
      </motion.div>
        ...
        <motion.div ref={ref} variants={boxVariant} initial="hidden" animate={control} className=' css-card-tile-cyan max-h-[380px] max-w-[500px] hover:drop-shadow-xl card basis-[100%]  py-12 px-10 m-10 md:mx-1 md:mb-10 rounded-lg '>
          <div className=" text-[#d1d0d0]  ">
            ...
            <div className='md:flex ml-5 md:flex-col'>
              <h1 className='md:mt-5 text-3xl font-bold '>Hi, This is <span className=' bg-gradient-to-br from-purple-500 to-cyan-400 text-transparent bg-clip-text inline-block font-bold'>Gaurav</span></h1>
          ...
          <div className=" text-[#d1d0d0]  inline-block md:mt-10">
            <div className='md:flex ml-2 md:flex-col '>
              <div className=' transition-all duration-200 hover:scale-110'>
                ...
                <h1 className=' mb-5 md:pl-4 text-2xl font-bold '>See My Resume</h1>
              </div>


              <Link href={"https://drive.google.com/file/d/1dCbTP8Yfbu2XyuiIobIUFpO1fIgTbJTs/view"}><button type='button' className='css-btn  transition-all ease-in-out shadow-xl rounded-xl duration-300 hover:rounded-3xl  md:mx-14 md:w-[120px] bg-gray-800 text-lg text-gray-200 px-4 py-2'>Resume</button></Link>
